...
function Images() {
  ...
  return (
    <div ref={parent}
      className="w-full h-[70vh] sm:h-[100vh] bg-white-600
    ...
    >
      <div className="w-[40%] sm:w-[20%] sm:h-[70%] h-1/2 relative">
        ...
        <div
          ref={second}
          className="absolute w-[8rem] sm:w-[20rem] aspect-video -left-1/2 sm:-left-2/3 top-1/3 overflow-hidden "
        >
          <video
            autoPlay
            muted
        ...
        <div
          ref={third}
          className="absolute w-[6rem] sm:w-[17rem] aspect-video -left-[20%] sm:-left-[30%] -bottom-10 "
        >
          <img
            className="w-full h-full object-cover"
        ...
        <div
          ref={fourth}
          className="absolute w-[9rem] sm:w-[17rem] sm:-bottom-[20%] aspect-[1.5/1] -right-[70%] sm:-right-[50%] -bottom-[10%] overflow-hidden "
        >
          <video
            autoPlay
            muted
            loop
            className="w-full h-full absolute top-1/2 left-1/2 -translate-x-1/3 -translate-y-1/3"
